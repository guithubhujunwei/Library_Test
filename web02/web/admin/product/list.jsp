...
<script type="text/javascript">
            ...
            function delProduct(pid){
                alert(pid);
                var b  =  window.confirm("确定删除该商品?");
                if(b){

                    /*
                      以pid作为参数, 向 Servlet 发送数据, 删除数据库商品信息 .
                     */
...
<body>
	<br>
	<form id="Form1" name="Form1" action="${pageContext.request.contextPath}/queryCondition" method="post">
        <tr   style="FONT-WEIGHT: bold; FONT-SIZE: 12pt; HEIGHT: 25px; BACKGROUND-COLOR: #afd1f3">
            <td align="center" width="18%">
                关键字 : <input type="text" name="keyWord" id="i1">
            </td>
            <td align="center" width="18%">
                最低价 : <input type="text" name="min_price" id="i2">
            </td>
            <td align="center" width="18%">
                最高价 : <input type="text" name="max_price" id="i3">
            </td>
            <td align="center" width="18%">
                <select name="is_hot">
            ...
            <td align="center" width="18%">
                <input type="submit" value="条件查询"></td></tr>
